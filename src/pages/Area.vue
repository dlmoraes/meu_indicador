    ...
    <div class="row justify-start">
            ...
            <q-card class="cartao_indicadores col-5 q-mr-sm">
              <q-markup-table class="dt_indicadores">
                ...
                <tbody>
                <tr :key="indicador.key" @click="setIndicador(indicador)" v-for="indicador in indicadores">
      ...
      <q-card class="col-12 cartao_grafico_mapa transparent no-shadow" style="height: 600px">
        <IEcharts
          :option="optionMap"
        />
      </q-card>
  ...
  export default {
        ...
        series: [
          {
            ...
            data: [
              ...
              {name: 'Acar�', value: 6553255},
              {name: 'Afu�', value: 2949131},
              {name: '�gua Azul do Norte', value: 38041430},
              {name: 'Alenquer', value: 5187582},
              {name: 'Almeirim', value: 3590347},
              {name: 'Altamira', value: 917092},
              {name: 'Anaj�s', value: 632323},
              {name: 'Ananindeua', value: 19317568},
              {name: 'Anapu', value: 9919945},
              {name: 'Augusto Corr�a', value: 1392313}
            ]
          }
        ]
      }
    ...
    methods: {
      async carregarMapa() {
        ...
        IEcharts.registerMap('Brasil', geojson);
      },
